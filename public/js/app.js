...
function exportBackup(){
  const data={version:'v2.10.0',exportAt:new Date().toISOString(),staff,records,tiers,projTypes,shifts,insuranceBrackets};
...
async function init(){
  ...
  document.getElementById('ver-badge').textContent='v2.10.0';
